...
/** \mainpage Handbuch
  ...
  Klicken Sie mit der linken Maustaste auf den Knopf \e Input.
  ...
  Haben Sie all ihre \e Input-Gatter eingestellt, können Sie entweder mittels der \e Enter-Taste, oder dem \e Play-Knopf die Schaltung berechnen.

  \section load_n_save_circuit Laden und Speichern
  Um Eine Schaltung zu Speichen, drücken Sie einfach den \e Speicher-Knopf neben dem \e Play-Knopf.
  Um Eine Schaltung zu Laden, drücken Sie einfach den \e Lade-Knopf neben dem \e Play-Knopf.
  ...
  Endung \e .otto ab.
  Danach können Sie die Datei im Logik-Simulator über den zweiten Öffnen-Dialog öffnen.
